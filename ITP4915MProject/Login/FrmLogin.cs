    ...
    public partial class FrmLogin : Form
    {
        ...
        private void btnLogin_Click(object sender, EventArgs e)
        {
            ...
            else if (staffBLL.checkValidation(staffID, password))                         //調用staffBBL的checkValidation方法 驗證登錄信息
            {
                ...
                this.Hide();                                                                             // 隱藏當前窗口
                FrmMainPage mainForm = new FrmMainPage();   //save the user login staff ID into globalVarianbles
        ...
        private void btnForgerPassword_Click_1(object sender, EventArgs e)
        {
