...
namespace DAL
{
    public class OrderDAL
    {
        ...
        public int InsertOrder(Order order) {
            ...
            string sql = "INSERT INTO `order` (OrderID, DealerID, StaffID, Status, OrderDate,OrderAmounts, TotalItem, Description) VALUES" +
                " (@OrderID, @DealerID, @StaffID, @Status, @OrderDate, @OrderAmounts, @TotalItem,@Description)";
        ...
        public string  InsertOrderReturnid(Order order)
        {
            string OrderID = GetNextCharId();
            string sql = "INSERT INTO `order` (OrderID, DealerID, StaffID, Status, OrderDate,OrderAmounts, TotalItem, Description) VALUES" +
                " (@OrderID, @DealerID, @StaffID, @Status, @OrderDate, @OrderAmounts, @TotalItem,@Description)";
        ...
        public void UpdateOrder(Order order) {
            string sql = "UPDATE order SET  " +
                ...
                "StaffID=@StaffID,Status=@Status,Description=@Description, OrderDate=@OrderDate,OrderAmounts=@OrderAmounts, TotalItem = @TotalItem WHERE OrderID = @OrderID";
            int row = msh.ExecuteNonQuery(sql,
